  ...
  "Statement": [
    {
      ...
      "Resource": [
        ...
        "arn:aws:s3:s3:eu-west-2:${dest_account_id}:accesspoint/farm-survey/object/${files_prefix}/*",
        "arn:aws:s3:s3:eu-west-2:${dest_account_id}:accesspoint/farm-survey/object/${records_prefix}/*"
      ]
    },
    {
      "Action": [
